...
export class Round {
    ...
    handleMove(move: Move) {
        ...
        if (opponentHand.hasCandidateCards(move.getCard())) {
    ...
    private isOptionalTurn(opponent: Player, move: Move) {
        const opponentHand = opponent.getHand();
        return this.pot.isChallenge() && opponentHand.hasCandidateCards(move.getCard());
    }
